...
namespace eVendas.SaleTest.Repository
{
    public class ProductRepositoryTest
    {
        ...
        {
            var fakeContext = new FakeContext("GetAllProducts_Sale");
        ...
        [InlineData(4)]
        [InlineData(5)]
        public void Test_GetById_Products_Sale(int id)
        {
            var fakeContext = new FakeContext("GetByIdProducts_Sale");
            fakeContext.FillWith<Product>();
        ...
        [Fact]
        public void Test_Create_Product_Sale()
        {
            var fakeContext = new FakeContext("Create_Products_Sale");
            fakeContext.FillWith<Product>();
        ...
        [InlineData(4)]
        [InlineData(5)]
        public void Test_Update_Product_Sale(int id)
        {
            var fakeContext = new FakeContext("Update_Products_Sale");
            fakeContext.FillWith<Product>();
        ...
        [Fact]
        public void Test_Delete_Product_Sale()
        {
            var fakeContext = new FakeContext("Delete_Products_Sale");
            fakeContext.FillWith<Product>();
